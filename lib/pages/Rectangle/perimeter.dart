...
class Perimater extends StatefulWidget {

  @override
  _PerimaterState createState() => _PerimaterState();
}

class _PerimaterState extends State<Perimater> {
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                "Perimeter = ${perimater.toStringAsFixed(2)}",
                style: TextStyle(fontSize: 30),
              ),
            )
          ],
